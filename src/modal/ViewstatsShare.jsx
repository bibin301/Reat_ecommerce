...
class ViewstasShare extends React.Component
{
    constructor(props) {
        super(props)
    ...
    //     //  }
    //     axios.get("https://cryptodesksapi.azurewebsites.net/api/OS/ASSET?address=" + this.props.params.address + "&tokenId=" + this.props.params.token)
    //     .then(response => {
    ...
    render()
    {
        ...
        const shareUrl = "https://cryptodeckstest.azurewebsites.net/viewStats?address="+params.address+"&token="+params.token
                ...
                <div className="modal-dialog">
                    ...
                    <div className="modal-content popupCont sharePopCont">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="sharemask"><span className="shareDeckText" onClick={(e) => this.sharePopup(e)}>Share deck</span></div>

                        </div> */}
                            </div>

                            {/* <div className="container section-container"> */}
                            {statusList && <div className="scrollDivheight">
                                <div className="cartoon_img">
                                    <img src={statusList.image_preview_url} alt="" />
                                </div>
                                <div className="caption_stats">
                                    <div className="contentView">
                                        <span className="title"> {statusList.name}</span>
                                        {/* <span className="subTitle">Gen {statusList.Views} | Cooldown index</span> */}
                                        <span className="subTitle">{statusList.traits.find(trait => trait.trait_type === "generation") == undefined ? "" : "Gen " + statusList.traits.find(trait => trait.trait_type === "generation").value } | { statusList.traits.find(trait => trait.trait_type === "cooldown_index") == undefined ? "" : "Cooldown Index " + statusList.traits.find(trait => trait.trait_type === "cooldown_index").value }</span>
                                    </div>
                                    ...
                                    <div className="valueShow">
                                        ...
                                        {statusList.last_price && (statusList.last_price).toFixed(2)}
                                        </span>
                                    </div>
                                    ...
                                    <div className="">
                                        <span className="ownedName" title='Gen 0|1/888'>Owned by {statusList.owner.address.slice(1, 8)}... </span>
                                    </div>
                                    <div className="deckTableScr">
                                        <table className="propertyTable_stats marginTop">
                                            ...
                                            {statusList.traits && statusList.traits.map((traits, i) => {
                                                return (<tbody key={i}>
                                                    <tr>
                                                        <td>{traits.value}</td>
                            ...
                            <div className="col-md-12 text-center margintpDn">
                                <p className="shareoOntext">Share this deck on</p>
                                <FacebookShareButton url={shareUrl}> <button type="button" className="blackGoastBtn pull-left" onClick={this.props.onHide} >
...
</svg> Facebook</button> </FacebookShareButton>
                                <TwitterShareButton url={shareUrl}><button type="submit" className="blackGoastBtn pull-right" onClick={this.handleSubmit}><img src={twit} alt="" />  Twitter</button></TwitterShareButton>
                            </div>
                            {/* </div> */}
