...
class Share extends React.Component {
    ...
    render() {
        const shareUrl = 'https://cryptodeckstest.azurewebsites.net/editDeck';
                                ...
                                <div className="modal-body">
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <div className="col-md-3">
                                            <div className="shareIconsShow deckSect marginTop20"><ul><li><span>
                                                ...
                                                <span className="infoViewVal">{singleDeckdata.Views}</span></li>
                                                <li>
                                        ...
                                        <div className="col-md-3">
                                            <div className="userNameDeck marginTop20">
                                                <span className="userNameLetter">L</span>
                                                <span className="infoViewVal userNameSpan">{singleDeckdata.User && singleDeckdata.User.Username}</span> </div>

                                        </div>
                                    </div>
                                    <div className="col-md-12">
                                        <div className="shareDeckBg">
                                            {this.state.data && this.state.data.map((each, i) => (
                                                <div key={i} className="shareDeck" >
                                                    <img alt="" src={each.image_preview_url} />
                                                </div>
                                            ))
                                            }
                                        </div>
                                    ...
                                    <div className="col-md-12 text-center margintpDn">
                                        ...
                                        <FacebookShareButton url={shareUrl}> <button type="button" className="blackGoastBtn pull-left" onClick={this.props.onHide} ><img src={fb} alt="" />  Facebook</button></FacebookShareButton>
