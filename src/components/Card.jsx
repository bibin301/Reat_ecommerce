...
//images
import following from '../asserts/images/follower.png';
...
class Card extends Component {
    ...
    //ENO function for share
    imageRotate = (i, each) => {
        this.setState({ rotateImage: !this.state.rotateImage, openDropDown: i });
    }
    ...
    render() {
        return (
            <div key={this.props.index} className="col-md-4 col-sm-6 col-xs-12">
                <div className={this.state.flip && this.props.index === this.state.flipDropdown ? "card-flip clicked" : "card-flip "}  >
                    <div className="card-flip-flipper">
                        <div className="force-overflow card-flip-content card-flip-content-front">
                            <div className="cartoon_sec" style={{ background: this.props.asset.background_color ? `#${this.props.asset.background_color}` : '#ffffff' }}
                                onClick={() => this.handleFlip(this.props.index, this.props.asset)} onMouseLeave={() => this.handleMouseLeave(this.props.index)}>
                                <div className={this.state.rotateImage && this.props.index === this.state.openDropDown ? 'cartoon_img ' : 'cartoon_img'} onDoubleClick={() => this.props.onGoToView(this.props.index, this.props.asset)}>
                                    <img src={this.props.asset.image_url} onClick={() => this.imageRotate(this.props.index, this.props.asset)} alt="" />
                                </div>

                                <div className="viewIcon"><svg width="15px" height="9px" viewBox="0 0 15 9" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span className="viewValue"> {this.props.asset.Views}</span>
                                </div>

                                <div className="viewIcon1">
                                    <img alt="follow" src={following} />
                                    <span className="viewValue"> {this.props.asset.Following}</span>
                                </div>
                                <div className="viewIcon2">
                                    <img alt="like" src={like} />
                                    <span className="viewValue"> {this.props.asset.Likes}</span>
                                </div>
                            ...
                            <div className="caption">
                                ...
                                <div className="contentView">
                                    <span className="title">{this.props.asset.name}</span>
                                    <span className="subTitle">{this.props.asset.traits.find(trait => trait.trait_type === "generation") === undefined ? "" : "Gen " + this.props.asset.traits.find(trait => trait.trait_type === "generation").value} | {this.props.asset.traits.find(trait => trait.trait_type === "cooldown_index") === undefined ? "" : "Cooldown Index " + this.props.asset.traits.find(trait => trait.trait_type === "cooldown_index").value}</span>
                                </div>
                                ...
                                <div className="valueShow">
                                    <span className="etherValue"><svg width="11px" height="18px" viewBox="0 0 11 18" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        {this.props.asset.last_price && this.props.asset.last_price.toFixed(2)}
                                    </span>

                                </div>

                            </div>
                            <div className="sharebgDiv">
                                <ul className="">
                                    <li ><a onClick={() => this.props.onShowModal(this.props.index, this.props.asset)}><svg width="12px" height="12px" viewBox="0 0 12 12" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                        <g id="Flow1:-Visualise-the-deck" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                    ...
                                    </svg>   &nbsp;&nbsp; Save to deck               </a></li>
                                    <li><a onClick={() => this.props.onShowShare(this.props.index)}><svg width="12px" height="13px" viewBox="0 0 12 15" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            ...
                            {this.state.isShareVisible && this.props.index === this.state.isShareVisibleIndex && <div className="deckHoverDivBg topVal">
                                <span>Share on</span>
                                <button type="button" className="shareOnbtn" onClick={() => this.share(this.props.asset, 1)} ><img src={fb} alt="" />  Facebook</button>
                                <button type="submit" className="shareOnbtn" onClick={() => this.share(this.props.asset, 2)}><img src={twit} alt="" /> Twitter</button>
                            </div>
                            }
                        </div>
                        <div className="force-overflow card-flip-content card-flip-content-back">
                            <table className="propertyTable marginTop">
                                ...
                                <tbody>
                                    {this.props.asset.traits && this.props.asset.traits.map((traits, i) => {

                                        return (<tr key={i}>
                                            <td>{traits.trait_type}</td>
                                            <td><span className="tabType typeClr">{traits.value}</span></td>
                                ...
                                {this.props.asset.traits.length === 0 && <span> no recordes found  </span>}
